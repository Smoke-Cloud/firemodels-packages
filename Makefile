...
# fds-6.4.0+smokecloud.gnu-6.4.0-1-x86_64.pkg.tar.zst \
# fds-6.5.0+smokecloud.gnu-6.5.0-1-x86_64.pkg.tar.zst \
# fds-6.5.1+smokecloud.gnu-6.5.1-1-x86_64.pkg.tar.zst \
# fds-6.5.2+smokecloud.gnu-6.5.2-1-x86_64.pkg.tar.zst \
# fds-6.5.3+smokecloud.gnu-6.5.3-1-x86_64.pkg.tar.zst \
# fds-6.6.0+smokecloud.gnu-6.6.0-1-x86_64.pkg.tar.zst \
# fds-6.7.0+smokecloud.gnu-6.7.0-1-x86_64.pkg.tar.zst \
# fds-6.7.1+smokecloud.gnu-6.7.1-1-x86_64.pkg.tar.zst \
# fds-6.7.3+smokecloud.gnu-6.7.3-1-x86_64.pkg.tar.zst \
# fds-6.7.4+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst \
# fds-6.7.5+smokecloud.gnu-6.7.5-1-x86_64.pkg.tar.zst \

# fds-5.5.3+smokecloud.gnu-5.5.3-1-x86_64.pkg.tar.zst \
# fds-6.1.2+smokecloud.gnu-6.1.2-1-x86_64.pkg.tar.zst \
# fds-6.2.0+smokecloud.gnu-6.2.0-1-x86_64.pkg.tar.zst \

install: default
	# pacman -U fds-6.7.6+smokecloud.gnu-6.7.6-1-x86_64.pkg.tar.zst --noconfirm
	...
	# pacman -U fds-6.7.3+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.7.1+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.7.0+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.6.0+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.5.3+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.5.2+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.5.1+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.5.0+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.4.0+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.3.2+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.3.1+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.3.0+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.2.0+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-6.1.2+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	# pacman -U fds-5.5.3+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst --noconfirm
	pacman -U fds-6.7.6+nist.ifort-6.7.6-1-x86_64.pkg.tar.zst --noconfirm
...
fds-6.7.6+nist.ifort-6.7.6-1-x86_64.pkg.tar.zst: 6.7.6+nist.ifort/PKGBUILD
	cd 6.7.6+nist.ifort && makepkg -f && cp $@ .. && cd ..

fds-5.5.3+smokecloud.gnu-5.5.3-1-x86_64.pkg.tar.zst: 5.5.3+smokecloud.gnu/PKGBUILD
	cd 5.5.3+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.1.2+smokecloud.gnu-6.1.2-1-x86_64.pkg.tar.zst: 6.1.2+smokecloud.gnu/PKGBUILD
	cd 6.1.2+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.2.0+smokecloud.gnu-6.3.0-1-x86_64.pkg.tar.zst: 6.2.0+smokecloud.gnu/PKGBUILD
	cd 6.2.0+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.3.0+smokecloud.gnu-6.3.0-1-x86_64.pkg.tar.zst: 6.3.0+smokecloud.gnu/PKGBUILD
	cd 6.3.0+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.3.1+smokecloud.gnu-6.3.1-1-x86_64.pkg.tar.zst: 6.3.1+smokecloud.gnu/PKGBUILD
	cd 6.3.1+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.3.2+smokecloud.gnu-6.3.2-1-x86_64.pkg.tar.zst: 6.3.1+smokecloud.gnu/PKGBUILD
	cd 6.3.2+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.4.0+smokecloud.gnu-6.4.0-1-x86_64.pkg.tar.zst: 6.4.0+smokecloud.gnu/PKGBUILD
	cd 6.4.0+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.5.0+smokecloud.gnu-6.5.0-1-x86_64.pkg.tar.zst: 6.5.0+smokecloud.gnu/PKGBUILD
	cd 6.5.0+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.5.1+smokecloud.gnu-6.5.1-1-x86_64.pkg.tar.zst: 6.5.1+smokecloud.gnu/PKGBUILD
	cd 6.5.1+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.5.2+smokecloud.gnu-6.5.2-1-x86_64.pkg.tar.zst: 6.5.2+smokecloud.gnu/PKGBUILD
	cd 6.5.2+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.5.3+smokecloud.gnu-6.5.3-1-x86_64.pkg.tar.zst: 6.5.3+smokecloud.gnu/PKGBUILD
	cd 6.5.3+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.6.0+smokecloud.gnu-6.6.0-1-x86_64.pkg.tar.zst: 6.6.0+smokecloud.gnu/PKGBUILD
	cd 6.6.0+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.7.0+smokecloud.gnu-6.7.0-1-x86_64.pkg.tar.zst: 6.7.0+smokecloud.gnu/PKGBUILD
	cd 6.7.0+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.7.1+smokecloud.gnu-6.7.1-1-x86_64.pkg.tar.zst: 6.7.1+smokecloud.gnu/PKGBUILD
	cd 6.7.1+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.7.3+smokecloud.gnu-6.7.3-1-x86_64.pkg.tar.zst: 6.7.3+smokecloud.gnu/PKGBUILD
	cd 6.7.3+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
...
fds-6.4.0+smokecloud.ifort-6.6.0-1-x86_64.pkg.tar.zst: 6.6.0+smokecloud.ifort/PKGBUILD
	cd 6.6.0+smokecloud.ifort && makepkg -f && cp $@ .. && cd ..
fds-6.5.0+smokecloud.ifort-6.6.0-1-x86_64.pkg.tar.zst: 6.6.0+smokecloud.ifort/PKGBUILD
	cd 6.6.0+smokecloud.ifort && makepkg -f && cp $@ .. && cd ..
fds-6.5.1+smokecloud.ifort-6.6.0-1-x86_64.pkg.tar.zst: 6.6.0+smokecloud.ifort/PKGBUILD
	cd 6.6.0+smokecloud.ifort && makepkg -f && cp $@ .. && cd ..
fds-6.5.2+smokecloud.ifort-6.6.0-1-x86_64.pkg.tar.zst: 6.6.0+smokecloud.ifort/PKGBUILD
	cd 6.6.0+smokecloud.ifort && makepkg -f && cp $@ .. && cd ..
fds-6.5.3+smokecloud.ifort-6.5.3-1-x86_64.pkg.tar.zst: 6.6.0+smokecloud.ifort/PKGBUILD
	cd 6.6.0+smokecloud.ifort && makepkg -f && cp $@ .. && cd ..
fds-6.6.0+smokecloud.ifort-6.6.0-1-x86_64.pkg.tar.zst: 6.6.0+smokecloud.ifort/PKGBUILD
	cd 6.6.0+smokecloud.ifort && makepkg -f && cp $@ .. && cd ..
