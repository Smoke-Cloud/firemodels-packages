...
fds-6.3.0+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst: 6.3.0+smokecloud.gnu/PKGBUILD
	cd 6.3.0+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.3.1+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst: 6.3.1+smokecloud.gnu/PKGBUILD
	cd 6.3.1+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.3.2+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst: 6.3.1+smokecloud.gnu/PKGBUILD
	cd 6.3.2+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.4.0+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst: 6.4.0+smokecloud.gnu/PKGBUILD
	cd 6.4.0+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.5.0+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst: 6.5.0+smokecloud.gnu/PKGBUILD
	cd 6.5.0+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.5.1+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst: 6.5.1+smokecloud.gnu/PKGBUILD
	cd 6.5.1+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.5.2+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst: 6.5.2+smokecloud.gnu/PKGBUILD
	cd 6.5.2+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.5.3+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst: 6.5.3+smokecloud.gnu/PKGBUILD
	cd 6.5.3+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.6.0+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst: 6.6.0+smokecloud.gnu/PKGBUILD
	cd 6.6.0+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.7.0+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst: 6.7.0+smokecloud.gnu/PKGBUILD
	cd 6.7.0+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.7.1+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst: 6.7.1+smokecloud.gnu/PKGBUILD
	cd 6.7.1+smokecloud.gnu && makepkg -f && cp $@ .. && cd ..
fds-6.7.3+smokecloud.gnu-6.7.4-1-x86_64.pkg.tar.zst: 6.7.3+smokecloud.gnu/PKGBUILD
