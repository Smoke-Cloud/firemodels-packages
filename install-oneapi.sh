...
chmod 755 l_HPCKit_p_2021.3.0.3230_offline.sh
...
sudo ./l_HPCKit_p_2021.3.0.3230_offline.sh   -s -a --silent  --eula accept --intel-sw-improvement-program-consent decline --components intel.oneapi.lin.inspector:intel.oneapi.lin.mpi.devel:intel.oneapi.lin.itac:intel.oneapi.lin.clck:intel.oneapi.lin.ifort-compiler:intel.oneapi.lin.dpcpp-cpp-compiler-pro    
